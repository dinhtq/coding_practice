...
We'll start at the head of the two nodes, and compute sum % 10. 
We write this down, move the two nodes up and add a carry if the sum was greater than 10.
...
Since this is tricky to represent in code, 
we instead extend the nodes one more until they are both None and carry is 0 and then simply return None.
